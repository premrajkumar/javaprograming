...
public class IccworldcupRankingsTest {
	@Test
	public void main() throws InterruptedException
	{
		...
		Thread.sleep(3000);
		driver.quit();
		//driver.findElement(By.xpath("//div[@class='main-navigation__header u-hide-desktop']//parent::li/button[contains(.,'Rankings')]")); ///for rankings xpath 
	}
